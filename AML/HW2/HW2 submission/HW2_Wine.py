...
if feat_select==1:
    ...
    if fs_type==2:
        rgr = RandomForestRegressor(n_estimators=100,max_features=0.33,max_depth=None,min_samples_split=3,criterion='squared_error',random_state=rand_st)
...
if binning==0 and cross_val==0:
    ...
    bag = BaggingRegressor(estimator=rgr,n_estimators=100,max_samples=0.6,random_state=rand_st)
