...
####Classifiers####
if  cross_val==0:    
    #SciKit Decision Tree start_ts=time.time()
    ...
    print('Decision Tree AUC:', scores_AUC)          # print("Runtime:", time.time()-start_ts)                                                           #AUC only works with binary classes, not multiclass            
